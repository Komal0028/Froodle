...
CRITTER_PANDA = '<svg class="critter critter-panda" viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg"> <ellipse cx="80" cy="140" rx="46" ry="14" fill="#262322" opacity="0.08"/> <circle cx="80" cy="90" r="55" fill="#FFFFFF" stroke="#262322" stroke-width="4"/> <circle cx="34" cy="42" r="20" fill="#262322"/> <circle cx="126" cy="42" r="20" fill="#262322"/> <circle cx="34" cy="42" r="8" fill="#4A4642"/> <circle cx="126" cy="42" r="8" fill="#4A4642"/> <ellipse cx="55" cy="85" rx="16" ry="21" fill="#262322" transform="rotate(-12 55 85)"/> <ellipse cx="105" cy="85" rx="16" ry="21" fill="#262322" transform="rotate(12 105 85)"/> <circle cx="57" cy="90" r="5" fill="#FFFFFF"/> <circle cx="103" cy="90" r="5" fill="#FFFFFF"/> <circle cx="57" cy="91" r="2.5" fill="#262322"/> <circle cx="103" cy="91" r="2.5" fill="#262322"/> <ellipse cx="80" cy="112" rx="8" ry="5" fill="#262322"/> <path d="M72 122 Q80 128 88 122" stroke="#262322" stroke-width="3" fill="none" stroke-linecap="round"/> <circle cx="44" cy="108" r="7" fill="#FF6A52" opacity="0.35"/> <circle cx="116" cy="108" r="7" fill="#FF6A52" opacity="0.35"/> </svg>'

CRITTER_ELEPHANT = '<svg class="critter critter-elephant" viewBox="0 0 180 170" xmlns="http://www.w3.org/2000/svg"> <ellipse cx="90" cy="150" rx="50" ry="14" fill="#262322" opacity="0.08"/> <ellipse cx="35" cy="85" rx="32" ry="38" fill="#C9D6E8" stroke="#262322" stroke-width="4"/> <ellipse cx="145" cy="85" rx="32" ry="38" fill="#C9D6E8" stroke="#262322" stroke-width="4"/> <circle cx="90" cy="88" r="58" fill="#DCE6F2" stroke="#262322" stroke-width="4"/> <path d="M72 128 Q64 158 78 168 Q86 172 88 160" fill="#DCE6F2" stroke="#262322" stroke-width="4" stroke-linecap="round"/> <circle cx="68" cy="82" r="6" fill="#262322"/> <circle cx="112" cy="82" r="6" fill="#262322"/> <circle cx="70" cy="80" r="2" fill="#FFFFFF"/> <circle cx="114" cy="80" r="2" fill="#FFFFFF"/> <circle cx="52" cy="104" r="7" fill="#FF6A52" opacity="0.3"/> <circle cx="128" cy="104" r="7" fill="#FF6A52" opacity="0.3"/> <path d="M66 108 Q90 122 114 108" stroke="#262322" stroke-width="3" fill="none" stroke-linecap="round"/> </svg>'

CRITTER_BEAR = '<svg class="critter critter-bear" viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg"> <ellipse cx="80" cy="140" rx="46" ry="14" fill="#262322" opacity="0.08"/> <circle cx="80" cy="90" r="55" fill="#D9A468" stroke="#262322" stroke-width="4"/> <circle cx="32" cy="40" r="21" fill="#D9A468" stroke="#262322" stroke-width="4"/> <circle cx="128" cy="40" r="21" fill="#D9A468" stroke="#262322" stroke-width="4"/> <circle cx="32" cy="40" r="9" fill="#F0C896"/> <circle cx="128" cy="40" r="9" fill="#F0C896"/> <ellipse cx="80" cy="102" rx="26" ry="20" fill="#F0C896" stroke="#262322" stroke-width="3.5"/> <circle cx="55" cy="85" r="6" fill="#262322"/> <circle cx="105" cy="85" r="6" fill="#262322"/> <circle cx="57" cy="83" r="2" fill="#FFFFFF"/> <circle cx="107" cy="83" r="2" fill="#FFFFFF"/> <ellipse cx="80" cy="98" rx="7" ry="5" fill="#262322"/> <path d="M80 103 L80 110" stroke="#262322" stroke-width="2.5"/> <path d="M70 112 Q80 118 90 112" stroke="#262322" stroke-width="3" fill="none" stroke-linecap="round"/> <circle cx="42" cy="106" r="7" fill="#FF6A52" opacity="0.3"/> <circle cx="118" cy="106" r="7" fill="#FF6A52" opacity="0.3"/> </svg>'

CRITTER_GIRAFFE = '<svg class="critter critter-giraffe" viewBox="0 0 160 170" xmlns="http://www.w3.org/2000/svg"> <ellipse cx="80" cy="150" rx="44" ry="13" fill="#262322" opacity="0.08"/> <rect x="62" y="88" width="36" height="55" rx="16" fill="#F2C879" stroke="#262322" stroke-width="4"/> <circle cx="80" cy="75" r="48" fill="#F2C879" stroke="#262322" stroke-width="4"/> <path d="M62 40 L58 20" stroke="#262322" stroke-width="5" stroke-linecap="round"/> <path d="M98 40 L102 20" stroke="#262322" stroke-width="5" stroke-linecap="round"/> <circle cx="58" cy="18" r="7" fill="#D9A468" stroke="#262322" stroke-width="3.5"/> <circle cx="102" cy="18" r="7" fill="#D9A468" stroke="#262322" stroke-width="3.5"/> <ellipse cx="80" cy="98" rx="20" ry="16" fill="#FBEBD0" stroke="#262322" stroke-width="3"/> <circle cx="60" cy="72" r="6" fill="#262322"/> <circle cx="100" cy="72" r="6" fill="#262322"/> <circle cx="62" cy="70" r="2" fill="#FFFFFF"/> <circle cx="102" cy="70" r="2" fill="#FFFFFF"/> <ellipse cx="80" cy="102" rx="6" ry="4" fill="#262322"/> <ellipse cx="40" cy="55" rx="8" ry="6" fill="#B9793B" opacity="0.7"/> <ellipse cx="118" cy="60" rx="7" ry="9" fill="#B9793B" opacity="0.7"/> <ellipse cx="70" cy="120" rx="7" ry="9" fill="#B9793B" opacity="0.6"/> <ellipse cx="92" cy="130" rx="8" ry="6" fill="#B9793B" opacity="0.6"/> </svg>'


def render_hero():
    critters = "".join(" ".join(s.split()) for s in (CRITTER_PANDA, CRITTER_ELEPHANT, CRITTER_BEAR, CRITTER_GIRAFFE))
    st.markdown(
        f"""<div class="hero">{critters}<div class="hero-content">
            <div class="hero-eyebrow">Air-drawing, sketched in real time</div>
            <div class="hero-title">Froodle</div>
            <svg class="hero-squiggle" width="220" height="18" viewBox="0 0 220 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 12C20 3 35 3 52 10C69 17 84 5 101 6C118 7 130 15 148 9C166 3 180 12 198 8C207 6 213 9 217 12" stroke="#FF6A52" stroke-width="4" stroke-linecap="round"/></svg>
